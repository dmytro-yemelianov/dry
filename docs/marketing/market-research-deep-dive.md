...
**Dry differentiation:** open, typed, embeddable, FFF/post-slicer review oriented, with an explicit clean-room
licensing story. Dry is not trying to own high-end LPBF build prep first.
