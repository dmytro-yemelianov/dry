...
- `[~]` **FM1.2** Quantity, syntax and well-formedness kernel. **Landed:** exact dimension exponent algebra, dimension-indexed quantities, same-dimension units with positive rational scales, canonical conversion/normalization coherence, a checked deposition-dimension identity, and the published L2 v0 logical syntax with structured failures, decidable well-formedness, acceptance/rejection equivalence and executable boundary fixtures. **Remaining:** L1 syntax after its public contract is frozen, serializer-neutral logical equality, fixture export suitable for Rust differential refinement, and future public quantity vocabulary after D1.2. *Dep: FM1.1; future quantities also depend on D1.2. Accept:* normalization/coherence/dimension theorems and validity decision equivalence are checked.
