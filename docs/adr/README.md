...
| [`0003-hosted-verification-service.md`](0003-hosted-verification-service.md) | Accepted | `services/cloud` is the sole public asynchronous ingress and `containers/verify-runner` is its private native verifier; the direct proxy is retired and `crates/cloud` remains archived measurement evidence. |
