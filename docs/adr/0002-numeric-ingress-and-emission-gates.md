...
- No binding-level test covers the new rejections. Judged a coverage gap rather than a risk, since the refused set was already broken downstream — but it should be closed before a release.
