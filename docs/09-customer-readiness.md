...
| SDK integrators | Medium | Rust core plus Python/TS/wasm adapters and deterministic conformance. | Formal IR spec, semver policy, public package releases, integration examples. |
