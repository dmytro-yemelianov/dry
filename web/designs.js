...
const DESIGNS = {
  ...
  tpms_gyroid: { label: 'TPMS gyroid contours', group: 'TPMS', tags: ['TPMS', 'gyroid', 'implicit'], ops: tpmsOps({ surface: 'gyroid', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_schwarz_p: { label: 'TPMS Schwarz P contours', group: 'TPMS', tags: ['TPMS', 'Schwarz P', 'implicit'], ops: tpmsOps({ surface: 'schwarz-p', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_schwarz_d: { label: 'TPMS Schwarz D contours', group: 'TPMS', tags: ['TPMS', 'Schwarz D', 'implicit'], ops: tpmsOps({ surface: 'schwarz-d', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_iwp: { label: 'TPMS I-WP contours', group: 'TPMS', tags: ['TPMS', 'I-WP', 'implicit'], ops: tpmsOps({ surface: 'iwp', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_neovius: { label: 'TPMS Neovius contours', group: 'TPMS', tags: ['TPMS', 'Neovius', 'implicit'], ops: tpmsOps({ surface: 'neovius', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_fks: { label: 'TPMS Fischer-Koch S contours', group: 'TPMS', tags: ['TPMS', 'FKS', 'implicit'], ops: tpmsOps({ surface: 'fischer-koch-s', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
  tpms_frd: { label: 'TPMS F-RD contours', group: 'TPMS', tags: ['TPMS', 'F-RD', 'implicit'], ops: tpmsOps({ surface: 'frd', cellsX: 1, cellsY: 1, cellsZ: 1, cellSize: 22, samplesPerCell: 16, layerHeight: 0.28 }) },
};
