//! Criterion benchmark for the windowed trace summary. Run locally with `cargo bench -p drymachina-trace`;
...
//! bench moved to `drymachina-kernel`, which cannot call the analysis layer — layer 3 depends on layer 1
