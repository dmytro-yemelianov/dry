...
EMIT_BOUNDARIES = {
    "FM1.F64.EMIT.ROTARY.SINGULAR_CONE",
    "FM1.F64.EMIT.ROBOT6.WRIST_SINGULAR_HOLD",
    "FM1.F64.EMIT.ROBOT6.REACH_REJECTION",
}
EMIT_LIMITS = {
    f"{EMIT_PROFILE_ID}.LIMIT.TOOL_DIRECTION_COMPONENT",
    f"{EMIT_PROFILE_ID}.LIMIT.ELBOW_COSINE",
}
EMIT_BUDGETS = {
    f"{EMIT_PROFILE_ID}.BUDGET.SINGULAR_CONE_SIN_TILT",
    f"{EMIT_PROFILE_ID}.BUDGET.HELD_C_TOOL_DIRECTION_ERROR_RAD",
    f"{EMIT_PROFILE_ID}.BUDGET.WRIST_SINGULAR_J5_RAD",
}
...
EMIT_IMPLEMENTATION_TOLERANCES = {
    ...
    f"{EMIT_PROFILE_ID}.BUDGET.WRIST_SINGULAR_J5_RAD": "WRIST_SINGULAR_J5_RAD",
}
CLOTHOID_SOURCES = {
